...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SharedPreferences pref = getSharedPreferences("sharedID", MODE_PRIVATE);
        final EditText idText = (EditText) findViewById(R.id.idText);
        final EditText passwordText = (EditText) findViewById(R.id.passwordText);
        final Button loginButton = (Button) findViewById(R.id.loginButton);
        idText.setText(pref.getString("sharedID", ""));
        passwordText.setText(pref.getString("sharedPassword", ""));
                    ...
                    public void onResponse(String response) {
                        try
                        {
                            ...
                            if(success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(LoginActivity.this);
                                dialog = builder.setMessage("아이디 혹은 비밀번호를 다시 확인하세요.")
